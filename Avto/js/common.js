...
$(document).ready(function() {
	...
	$(".main-item-wrap ul").each(function() {
		$(this).after("<div class='main-item-wrap-after'></div>");
	});
	$(".item-toggle").click(function() {
		if($(this).parent().parent().children("ul").is(":visible")) {
			$(this).parent().parent().children("ul").slideUp();
			$(this).parent().parent().children(".main-item-wrap-after").hide();
		} else {
			$(".main-item-wrap > ul, .main-item-wrap-after").hide();
			$("main-item-wrap").removeClass("active");
			$(this).parent().parent().addClass("active");
			$(this).parent().parent().children("ul").slideDown();
			$(this).parent().parent().children(".main-item-wrap-after").show(0);
		}		
	});
	...
	var eqElement = ".section-items, .sb-clear > div"
